...
run: build
	@qemu-system-i386 -m 4G -drive format=raw,file=../bin/OS.image
...
build: utils bin/second_stage.o ../bin/kernel.o bin/mbr_partition_table.o bin/higher_half_kernel.o
